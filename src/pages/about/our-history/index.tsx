...
import { History, Calendar, Users, Target, Building } from 'lucide-react';
  ...
  const milestones: Milestone[] = [
    {
      year: '2016',
      title: 'Establishment',
      description: 'The National Youth Service (NYS) was established by an Act of Parliament, mandating the recruitment and training of young people aged 15-35 years.',
      icon: <Building className="h-8 w-8" />
    },
    {
      year: '2018',
      title: 'First Batch Deployment',
      description: 'Successfully deployed our first batch of 200 graduate corps, inaugurated at the Peace Keeping Military Center.',
      icon: <Users className="h-8 w-8" />
    },
    {
      year: '2020',
      title: 'Program Expansion',
      description: 'Expanded our training programs to include Agriculture, Construction, Automobile Engineering, Hospitality and Tourism.',
      icon: <Target className="h-8 w-8" />
    },
    {
      year: '2023',
      title: 'National Impact',
      description: 'Thousands of young Sierra Leoneans trained and contributing to various sectors of the economy through our programs.',
            ...
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                  Building a legacy of youth empowerment since 2016
                </p>
              </div>
            </div>
          </div>
          ...
          <Card className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12">
            ...
            <CardContent className="p-6">
              <p className="text-gray-600 leading-relaxed">
                The National Youth Service (NYS) was established by an Act of Parliament in 2016. The NYS Act mandates the institution to recruit young people between the ages of 15-35 years and train them in various disciplines including but not limited to: Agriculture, Construction, Automobile Engineering, Hospitality and Tourism.
              </p>
            </CardContent>
          </Card>
              ...
              <Card key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <CardHeader className="bg-gradient-to-r from-green-200 to-blue-400 text-black p-6">
                  <div className="flex items-center gap-4">
                    {milestone.icon}
                    <div>
                      <div className="text-sm text-blue-100">{milestone.year}</div>
          ...
          <div className="mt-16 bg-gradient-to-r from-green-200 to-blue-400 rounded-2xl py-16 px-8">
            <div className="grid md:grid-cols-3 gap-8 text-center text-black">
              <div>
                ...
                <div className="text-blue-100 text-black">Graduates Trained</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-blue-100 text-black">Years of Impact</div>
              </div>
            </div>
          </div>
        </div>
