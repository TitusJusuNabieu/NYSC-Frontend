...
const VisionAndMission = () => {
  const coreValues = [
    ...
    },
    {
      ...
      description: 'Upholding best practices and ethical conduct in all our operations'
    },
    {
      title: 'Innovation',
      description: 'Embracing new ideas and creative solutions to youth development'
    },
    {
      title: 'Integrity',
      description: 'Operating with honesty, transparency and accountability'
    },
    {
      title: 'Teamwork',
      description: 'Fostering collaboration and mutual support among all stakeholders'
    },
    {
      title: 'Environmental sustainability',
      description: 'Promoting responsible environmental stewardship in all activities'
    }
  ];
      ...
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                  Empowering the youth for national development and creating lasting impact
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 mt-12">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <Card className="bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <CardContent className="p-6">
                <p className="text-gray-600 leading-relaxed">
                  The National Youth Service (NYS) aims to promote youth participation in governance and national development. It seeks to develop skills, knowledge, and the ability to make a better transition into adulthood. The NYS also focuses on capacity-building programs for leadership, youth-driven poverty alleviation programs, and integrating community service into tertiary education and the school curriculum.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              These principles guide our actions and define our commitment to youth development
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreValues.map((value, index) => (
              <Card key={index} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow">
                <CardContent className="p-6">
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 text-center text-black">
              <div>
                ...
                <div className="text-blue-100 text-black">Youth Trained Annually</div>
              </div>
              <div>
                <div className="text-4xl font-bold mb-2">85%</div>
                <div className="text-blue-100 text-black">Employment Rate</div>
              </div>
              <div>
                <div className="text-4xl font-bold mb-2">500+</div>
                <div className="text-blue-100 text-black">Community Projects</div>
              </div>
            </div>
          </div>
        </div>
