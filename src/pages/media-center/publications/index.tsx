...
const navigationItems = [
  ...
  const reports: Report[] = [
    ...
    {
      id: '3',
      description: 'Youth Impact Assessment',
      year: '2023',
      month: 'JUNE',
      type: 'report',
      fileSize: '1.8 MB'
  ...
  const filteredReports = reports.filter(report => {
    return (selectedYear === '' || report.year === selectedYear) && 
           (selectedMonth === '' || report.month === selectedMonth);
  });
            ...
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                  Access our reports, research papers, and official publications
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 mt-16 pb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredReports.map((report) => (
              <Card key={report.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span>{report.month.charAt(0) + report.month.slice(1).toLowerCase()}</span>
                        </div>
                      </div>
